...
/* ==========================================================================
  ...
  ========================================================================== */
     ...
     *
     */
    function witcom_acf_block_glide_slider_blocks() {
        ...
        acf_register_block_type( array(
            'name'            => 'witcom-acf-block-glide-starter',
            'title'           => __( 'WitCom Glide Slider' ),
...
//            wp_enqueue_style( 'witcom-coupon-grid-styles', plugin_dir_url( __FILE__ ) . 'dist/block-styles.css' );
    ...
    add_action( 'acf/init', 'witcom_acf_block_glide_slider_blocks' );
