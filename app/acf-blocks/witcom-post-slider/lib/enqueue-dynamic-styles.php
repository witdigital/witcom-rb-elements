...
//    Include SCSS - creates the dynamic SCSS
     ...
     */
    function witcom_acf_post_slider_dynamic_styles() {
        ...
        if ( has_blocks( $post->post_content ) ) {
            ...
            if ( $blocks[0]['blockName'] === 'acf/witcom-coupon-grid' ) {
                ...
                echo ("<style id='witcom_acf_post_slider_styles'>");
    ...
    add_action('wp_footer','witcom_acf_post_slider_dynamic_styles',100);
    add_action('admin_footer','witcom_acf_post_slider_dynamic_styles',100);
