...
/* ==========================================================================
  ...
  ========================================================================== */
     ...
     *
     */
    function witcom_acf_block_post_slider_blocks() {
        ...
        acf_register_block_type( array(
            'name'            => 'witcom-acf-block-post-slider',
            'title'           => __( 'WitCom Posts Slider' ),
...
//            wp_enqueue_style( 'witcom-coupon-grid-styles', plugin_dir_url( __FILE__ ) . 'dist/block-styles.css' );
    ...
    add_action( 'acf/init', 'witcom_acf_block_post_slider_blocks' );


add_filter('acf/load_field/name=witcom_posts_slider_post_type', 'acf_load_post_types');
