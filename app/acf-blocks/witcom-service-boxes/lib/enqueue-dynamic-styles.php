...
//    Include SCSS - creates the dynamic SCSS
     ...
     */
    function witcom_services_boxes_grid_dynamic_styles() {
        ...
        if ( has_blocks( $post->post_content ) ) {
            ...
            if ( $blocks[0]['blockName'] === 'acf/witcom-coupon-grid' ) {
                ...
                echo ("<style id='witcom_services_boxes_grid_styles'>");
    ...
    add_action('wp_footer','witcom_services_boxes_grid_dynamic_styles',100);
    add_action('admin_footer','witcom_services_boxes_grid_dynamic_styles',100);
