...
/* ==========================================================================
  ...
  ========================================================================== */
     ...
     *
     */
    function witcom_read_more_block_register_blocks() {
        ...
        acf_register_block_type( array(
            'name'            => 'witcom-read-more-block',
            'title'           => __( 'WitCom Read More Block' ),
...
//            wp_enqueue_style( 'witcom-coupon-grid-styles', plugin_dir_url( __FILE__ ) . 'dist/block-styles.css' );
    ...
    add_action( 'acf/init', 'witcom_read_more_block_register_blocks' );
