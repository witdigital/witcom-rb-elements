...
/* ==========================================================================
  ...
  ========================================================================== */
     ...
     *
     */
    function witcom_witcom_accordion_register_blocks() {
        ...
        acf_register_block_type( array(
            'name'            => 'witcom-witcom-accordion',
            'title'           => __( 'WitCom Accordion' ),
...
//            wp_enqueue_style( 'witcom-coupon-grid-styles', plugin_dir_url( __FILE__ ) . 'dist/block-styles.css' );
    ...
    add_action( 'acf/init', 'witcom_witcom_accordion_register_blocks' );
